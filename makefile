all: release debug
debug:
	scons -j8 -Q arch=x86_64 build=native neon=0 opencl=0 build_dir=debug debug=1
release:
	scons -j8 -Q arch=x86_64 build=native neon=0 opencl=0 build_dir=release debug=0
al2:
